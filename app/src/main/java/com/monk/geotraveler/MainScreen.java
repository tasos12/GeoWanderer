...
public class MainScreen extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInAccount account = (GoogleSignInAccount) intent.getExtras().get("ACC_INFO");

        //Changing welcome message
        TextView contentScreenWelcomeMessage = findViewById(R.id.contentScreenWelcomeMessage);
        contentScreenWelcomeMessage.setText("Welcome " + account.getGivenName());
        ...
        barGmailNameText.setText(account.getDisplayName());
        barGmailText.setText(account.getEmail());

        //Google Maps Fragment
        GoogleMapFragment mGoogleMapFragment = (GoogleMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
    }
